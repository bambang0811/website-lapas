...
function Admin() {
  ...
  return (
    <AdminLayout user={user} onLogout={handleLogout} activeTab={activeTab} onTabChange={setActiveTab}>
      {activeTab === 'dashboard' && (
        <div className="space-y-6">
          <div>
            <h1 className="text-2xl font-heading font-bold text-gray-900">Dashboard Admin</h1>
            <p className="text-gray-600">Kelola konten website LAPAS Karawang</p>
          </div>
            ...
            <Card className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xs text-gray-500">{stats.publishedBerita} published</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.publishedBerita}</p>
            ...
            <Card className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.draftBerita}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Quick Actions */}
            <Card className="p-6">
              <h2 className="text-lg font-heading font-semibold text-gray-900 mb-4">Aksi Cepat</h2>
              <div className="grid grid-cols-1 gap-3">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-medium text-primary-700">Tambah Berita Baru</p>
                      <p className="text-xs text-primary-600">Buat konten berita terbaru</p>
                    </div>
                  </div>
                </button>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-medium text-blue-700">Lihat Website</p>
                      <p className="text-xs text-blue-600">Preview halaman publik</p>
                    </div>
                  </div>
                </button>
                ...
                <button className="p-4 bg-green-50 hover:bg-green-100 rounded-lg border border-green-200 transition-colors duration-200 text-left">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-medium text-green-700">Lihat Statistik</p>
                      <p className="text-xs text-green-600">Analisis performa website</p>
                    </div>
                  </div>
                </button>
                ...
                <button className="p-4 bg-purple-50 hover:bg-purple-100 rounded-lg border border-purple-200 transition-colors duration-200 text-left">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-medium text-purple-700">Pengaturan</p>
                      <p className="text-xs text-purple-600">Konfigurasi sistem</p>
                    </div>
                  </div>
                </button>
              </div>
            ...
            <Card className="p-6 lg:col-span-2">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-heading font-semibold text-gray-900">Berita Terbaru</h2>
                <button
                  onClick={() => setActiveTab('berita')}
              ...
              <div className="space-y-4">
                {stats.recentBerita.length === 0 ? (
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p className="text-sm">Klik "Tambah Berita Baru" untuk memulai</p>
                  </div>
                ) : (
                  stats.recentBerita.map((berita) => (
                    <div key={berita.id} className="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                      {berita.gambar ? (
                        <img
                          src={berita.gambar}
                          alt={berita.judul}
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-sm font-medium text-gray-900 truncate">{berita.judul}</h3>
                        <p className="text-xs text-gray-500">{berita.tanggal} • {berita.kategori}</p>
          ...
          {/* Activity Timeline */}
          <Card className="p-6">
            <h2 className="text-lg font-heading font-semibold text-gray-900 mb-4">Aktivitas Terbaru</h2>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                <div className="flex-1">
                  <p className="text-sm text-gray-600">Dashboard admin berhasil dimuat</p>
